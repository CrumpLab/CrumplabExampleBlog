---
title: "Week 12: Example final project"
author: "Matt Crump"
date: "4/26/2023"
...
The experiment involved a classic test of selective attention, called the Stroop effect. In a typical Stroop experiment, subjects name the ink color of words as fast as they can. On congruent trials the color and word match; and, on incongruent trial the color and word mismatch. 
...
```{r}
#| echo: false
knitr::include_graphics("imgs/Fig1_original.png")
```
...
# load data
all_data <- rio::import("data/stroop_stand.csv")
